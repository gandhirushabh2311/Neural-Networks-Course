...
% TO ADDRESS THE 4-CLASS CLASSIFICATION PROBLEM.
...
%%%%% PREPARING INPUT/OUTPUT FOR TRAINING OF THE PERCEPTRON NETWORK %%%%%%%
...
%%% This loop allows the network to adapt for xx passes, plots the 
%%% classification line, and continues until the error is zero.
...
view(net);
%%
%%%%% TEST THE PERCEPTRON NETWORK FOR A NEW INPUT %%%%%%%
% For example, classify an input vector of [0.7; 1.2]
p = [0.7; 1.2];
y = net(p);
disp(strcat('THE OUTPUT CLASS IS -- >',num2str(y)));
