%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% THIS IS AN EXPERIMENT TO CREATE AND TRAIN A NONLINEAR AUTOREGRESSIVE 
% NEURAL NETWORK TO ADDRESS THE PREDICTION OF CHAOTIC TIME SERIES PROBLEM.
...
%%%%% GENERATE INPUT DATA (MACKAY-GLASS TIME SERIES) %%%%%%%
% data settings
...
%%%%% PREPARE INPUT/OUTPUT TIME SERIES DATA FOR NETWORK TRAINING %%%%%%%
...
%%%%% TRANSFORM NETWORK TO A CLOSED LOOP NAR NETWORK %%%%%%
