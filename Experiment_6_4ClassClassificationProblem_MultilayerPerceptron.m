%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% THIS IS AN EXPERIMENT TO CREATE AND TRAIN A MULTILAYER 
% PERCEPTRON NETWORK TO ADDRESS 4-CLASS CLASSIFICATION PROBLEM.
...
%%%%% DEFINE OUTPUT CODING FOR ALL THE CLASSES %%%%%%%
...
%%%%% CREATE AND TRAIN A MULTILAYER PERCEPTRON NETWORK %%%%%%%
...
%%%%%%%%% CLASSIFICATION RESULTS FOR COMPLETE INPUT SPACE %%%%%%
% generate a grid
span = -1:.01:2;
